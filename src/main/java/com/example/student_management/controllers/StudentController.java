...
public class StudentController {
    ...
    @Operation(summary = "Sauvgareder l'étudiant")
    @PostMapping("/save")
    ...
    @Operation(summary = "Récupérer le nombre de tous les étudiants")
    @GetMapping("/count")
    public ResponseEntity<Long> countStudent() {
        long count = studentService.countStudents();
        return new ResponseEntity<>(count, HttpStatus.OK);
    }
    @Operation(summary = "Récupérer l'année de tous les étudiants")
    @GetMapping("/byYear")
